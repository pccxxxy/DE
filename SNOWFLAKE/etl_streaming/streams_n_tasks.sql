-- SQL Worksheet for "Getting Started with Streams and Tasks"
...
grant all privileges on warehouse VHOL_WH to role VHOL;
 ...
 --create or replace warehouse VHOL_WH_2 WAREHOUSE_SIZE =LARGE, AUTO_SUSPEND = 5, AUTO_RESUME= TRUE;
...
select count(*) from CC_TRANS_STAGING_VIEW;
select count(*) from CC_TRANS_STAGING_VIEW_STREAM;
select * from CC_TRANS_STAGING_VIEW_STREAM limit 100;
